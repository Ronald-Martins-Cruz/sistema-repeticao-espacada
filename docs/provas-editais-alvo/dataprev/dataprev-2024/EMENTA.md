# Ementa DATAPREV 2024 — Analista de TI / Perfil 3: Desenvolvimento de Software

Transcrição do **Anexo I – Conteúdo Programático** do
[edital-dataprev-2024.pdf](edital-dataprev-2024.pdf)
(Empresa de Tecnologia e Informações da Previdência – DATAPREV, Edital nº 1, de
5 de setembro de 2024, banca **FGV**), recortada para o que cai na prova de quem
concorre a **Analista de Tecnologia da Informação – Perfil 3: Desenvolvimento de
Software**: o Módulo I, comum a todos os cargos/perfis, e o bloco do Perfil 3
dentro do Módulo II.

Prova aplicada em **17/11/2024**, das 13h às 17h. Caderno:
[ati-desenvolvimento-de-software-cns003-tipo-01.pdf](ati-desenvolvimento-de-software-cns003-tipo-01.pdf).

Texto extraído do PDF oficial, sem paráfrase. A numeração corrida do edital
(`1`, `2`, `2.1`…) foi preservada como está no original — inclusive onde ela
salta ou se repete; ver [Ressalvas de transcrição](#ressalvas-de-transcrição) ao
pé.

> Este é o edital **anterior** ao do alvo atual. O que mudou de 2024 para 2026
> está em
> [DIFF-EDITAIS-2024-2026.md](../DIFF-EDITAIS-2024-2026.md);
> a ementa vigente, em
> [EMENTA-DESENVOLVIMENTO-SOFTWARE-2026.md](../EMENTA-DESENVOLVIMENTO-SOFTWARE-2026.md).

## Estrutura da prova

70 questões objetivas de múltipla escolha (5 alternativas, 1 correta), **sem
prova discursiva**. Os dois módulos têm pesos diferentes: 1 ponto por questão no
Módulo I e 2,5 pontos por questão no Módulo II, num máximo de **115 pontos**
(item 9.7).

| Módulo | Disciplina | Questões | Peso | Pontuação máxima |
|---|---|:--:|:--:|:--:|
| I — Conhecimentos Gerais | Língua Portuguesa | 12 | 1 | 12 |
| I — Conhecimentos Gerais | Língua Inglesa | 12 | 1 | 12 |
| I — Conhecimentos Gerais | Raciocínio Lógico Matemático | 6 | 1 | 6 |
| I — Conhecimentos Gerais | Atualidades | 5 | 1 | 5 |
| I — Conhecimentos Gerais | Legislação Acerca de Segurança da Informação e Proteção de Dados | 5 | 1 | 5 |
| II — Conhecimentos Específicos | Conhecimentos Específicos (Perfil 3) | 30 | 2,5 | 75 |
| | **Total** | **70** | | **115** |

No caderno, a numeração segue essa ordem: **1–12** Língua Portuguesa, **13–24**
Língua Inglesa, **25–30** Raciocínio Lógico Matemático, **31–35** Atualidades,
**36–40** Legislação e **41–70** Conhecimentos Específicos.

O Módulo II sozinho vale 75 dos 115 pontos (65% da nota) — é onde a
classificação se decide.

Aprovação na objetiva exigia, cumulativamente (item 9.18): no mínimo **57,5
pontos** no total **e não zerar nenhuma disciplina**.

> A tabela do edital chama a disciplina de "Raciocínio Lógico Matemático"; o
> cabeçalho do Anexo I, logo abaixo, diz apenas "RACIOCÍNIO LÓGICO". As duas
> grafias são do original.
...
1 Modelagem de dados (conceitual, lógica e física). 2 Abordagem relacional e multidimensional. 3 Normalização das estruturas de dados. 4 Integridade referencial. 5 Metadados. 6 Modelagem dimensional. 7 Linguagem de consulta estruturada (SQL). 8 Linguagem de definição de dados (DDL). 9 Linguagem de manipulação de dados (DML). 10 SGBD. 11 Propriedades de banco de dados. 12 Banco de dados NoSQL. 13 Banco de dados em memória. 14 Data lakes e soluções para big data. 15 Dados Estruturados e não Estruturados. 16 Avaliação de modelos de dados. 17 Técnicas de Integração e Ingestão de Dados (ETL/ELT, Transferência de Arquivos e Integração via Base de Dados).

### GESTÃO E GOVERNANÇA DE TECNOLOGIA DA INFORMAÇÃO

1 Gerenciamento de projetos: conceitos; áreas de conhecimento, projetos, programas, portfólio, Tipos de Abordagem: tradicional, hibrida e ágil (Framework Scrum, Metodologia Lean, e Método Kanban); Guia Scrum de prática ágil para gerenciamento de projetos 2 Processos, grupos de processos e área de conhecimento. 3 Gestão de riscos. 4 Gerenciamento de serviços (ITIL v4). 4.1 Conceitos básicos, disciplinas, estrutura e objetivos. 5 Governança de TI (COBIT 2019). 5.1 Conceitos básicos, estrutura e objetivos. 6 Conceitos de gestão de processos e modelagem de processos de negócio usando BPMN.

---

## Ressalvas de transcrição

O Anexo I de 2024 é irregular, e a transcrição preserva as irregularidades em
vez de consertá-las — quem for escrever recurso precisa do texto como ele está:

- **`MODULO` sem acento** nos dois cabeçalhos de módulo, e `CONHECIMENTOS
  ESPECÍFICOS:` com dois-pontos, no original.
- **Desenvolvimento de Sistemas, item 7.** O bloco `TESTES` vem embutido dentro
  do item 7 (Git), sem número próprio, e a subnumeração pula direto para
  `7.3 RPA` — não existem `7.1` nem `7.2` no edital.
- **Segurança da Informação: dois itens `3`.** Um para as normas ISO 27001/27002
  e outro para confiabilidade/integridade/disponibilidade. A numeração segue de
  `4` em diante como se houvesse um só.
- **Aspas órfãs** em `Dynamic Application Security Testing”)` — aspas de
  fechamento sem abertura, como no original.
- **Legislação, item 1:** `Dec. nº 7.724 e nº 7845` — o segundo decreto aparece
  sem o ponto de milhar (é o Decreto nº 7.845/2012).
- **`iOs`** (Desenvolvimento de Sistemas, item 1) é a grafia do edital.
