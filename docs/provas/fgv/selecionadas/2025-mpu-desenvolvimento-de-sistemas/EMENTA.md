# Ementa MPU 2025 — A06 Analista do MPU / Desenvolvimento de Sistemas

Transcrição do **Anexo I – Conteúdo Programático** do
[edital-mpu-2025-01-retificado.pdf](edital-mpu-2025-01-retificado.pdf)
(Ministério Público da União, Edital nº 01/2025, banca **FGV**), recortada para
o que cai na prova de quem concorre ao cargo **A06 – Analista do MPU /
Desenvolvimento de Sistemas**: o Módulo I e as disciplinas do Módulo II que
alcançam o cargo, mais o bloco de Conhecimentos Específicos do A06.

Prova aplicada em **04/05/2025**. Caderno:
[fgv-2025-mpu-analista-desenvolvimento-de-sistemas-tipo-1.pdf](fgv-2025-mpu-analista-desenvolvimento-de-sistemas-tipo-1.pdf).

Texto extraído do PDF oficial, sem paráfrase.

## Estrutura da prova

80 questões objetivas de múltipla escolha (5 alternativas, 1 correta), valendo
80 pontos, mais **redação**. A distribuição abaixo é a de "Analista do MPU –
demais especialidades (exceto cargos de Perito)", que é onde o A06 se encaixa.

| Módulo | Disciplina | Questões |
|---|---|:--:|
| I | Língua Portuguesa | 15 |
| I | Noções de Sustentabilidade | 5 |
| I | Noções de Direitos Humanos e Fundamentais e de Acessibilidade | 5 |
| I | Noções de Administração Pública | 5 |
| II | Legislação Institucional | 5 |
| II | Noções de Direito Administrativo | 5 |
| II | Conhecimentos Específicos | 40 |
| | **Total** | **80** |

Aprovação exige, entre outros mínimos, **12 acertos no Módulo I**.

> É a prova selecionada com o bloco específico mais largo: os 40 do A06 cobrem
> governança, BPM, arquitetura, dados e IA além do desenvolvimento em si.
